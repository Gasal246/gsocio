...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    ...
    if(!newUser){
      return toast({ title: "No new User Sign-up failed! please try again.." });
    } 
    ...
    if(!session){
      return toast({ title: "No Session Sign-up failed! please try again.." });
    } 
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">To use Gosocio enter your account details..</p>
